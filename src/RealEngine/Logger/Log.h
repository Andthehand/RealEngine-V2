...
#define RE_CORE_INFO(...)		LOG_INFO(::RealEngine::Log::GetCoreLogger(), __VA_ARGS__);			RE_INTERNAL_PROFILE_TRACE_INFO(__VA_ARGS__)
...
#define RE_INFO(...)		LOG_INFO(::RealEngine::Log::GetClientLogger(), __VA_ARGS__);			RE_INTERNAL_PROFILE_TRACE_INFO(__VA_ARGS__)
